...
class JsonSonValidator {
  ...
  JsonSonValidator minLength(String key, int length, {String? message}) {
    if (_json.hasKey(key) && _json.rawData[key] != null) {
      ...
      if (value != null && value.length < length) {
        _errors[key] = message ?? 'Field "$key" must be at least $length characters long';
      }
    }
    return this;
  }
  ...
  JsonSonValidator maxLength(String key, int length, {String? message}) {
    if (_json.hasKey(key) && _json.rawData[key] != null) {
      final value = _json.getString(key);
      if (value != null && value.length > length) {
        _errors[key] = message ?? 'Field "$key" must be at most $length characters long';
      }
    }
    return this;
  }
  ...
  JsonSonValidator oneOf<T>(String key, List<T> allowedValues, {String? message}) {
    if (_json.hasKey(key) && _json.rawData[key] != null) {
      final value = _json.rawData[key];
      if (!allowedValues.contains(value)) {
        _errors[key] = message ?? 'Field "$key" must be one of: ${allowedValues.join(', ')}';
      }
    }
    return this;
  }
  ...
  JsonSonValidator custom(String key, bool Function(dynamic value) validator, {String? message}) {
    if (_json.hasKey(key) && _json.rawData[key] != null) {
      final value = _json.rawData[key];
      if (!validator(value)) {
  ...
  JsonSonValidator nested(String key, void Function(JsonSonValidator validator) validatorFn, {String? message}) {
    if (_json.hasKey(key) && _json.rawData[key] != null) {
  ...
  JsonSonValidator eachItem(String key, void Function(JsonSonValidator validator, int index) validatorFn, {String? message}) {
    if (_json.hasKey(key) && _json.rawData[key] != null) {
      final value = _json.rawData[key];
      if (value is List) {
